Sample .NET GUI application that generates managed exception and catches it with BugTrap.
Open BugTrapNetTest.sln solution file in Visual Studio and build the application.
